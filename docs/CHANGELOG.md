...
- Added the standalone Egg Catcher game: four-lane egg movement, three-button basket controls, score, misses, pause/restart flow, increasing difficulty, battery status, code-drawn graphics, and host-tested game logic.
