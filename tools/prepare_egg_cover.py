#!/usr/bin/env python3
"""Prepare the user-supplied full-screen Egg Catcher cover artwork."""
...
SOURCE = ROOT / "assets/images/egg-catcher-cover-source.png"
OUTPUT = ROOT / "main/assets/egg_game_cover.rgb565"
SCREEN_SIZE = (240, 320)
...
def main() -> None:
    ...
    if OUTPUT.stat().st_size != expected:
        raise ValueError(f"unexpected cover image size: {OUTPUT.stat().st_size}")
